namespace GameTool
{
    public static class GameDataControl
    {
        ...
        {
            GameData.Instance.SaveData(eData.CurLevel, GameData.Instance.Data.CurLevel);
            GameData.Instance.SaveData(eData.CurStage, GameData.Instance.Data.CurStage);
        ...
        {
            GameData.Instance.LoadData(eData.CurLevel, ref GameData.Instance.Data.CurLevel);
            GameData.Instance.LoadData(eData.CurStage, ref GameData.Instance.Data.CurStage);
